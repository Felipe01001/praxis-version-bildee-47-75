...
import { Task, TaskStatus, Client, TaskUpdate, TaskAttachment } from '@/types';
...
const Tasks = () => {
  ...
  return <div className="container mx-auto space-y-6 py-0 px-0">
      <div className="flex items-center justify-between">
        <h1 className="text-3xl font-bold mx-0 px-0 my-0 py-0">Tarefas</h1>
      ...
      <Card className="w-full mx-0 my-[8px] px-0 py-0">
      ...
      <Card>
        ...
        <CardContent>
          {sortedTasks.length > 0 ? <div className="space-y-3">
              {sortedTasks.map(task => <TaskCard key={task.id} task={task} clients={clients} cases={cases} onViewTask={handleViewTask} onEdit={() => {
            setSelectedTask(task);
            handleEditTask();
          }} onDeleteTask={confirmDeleteTask} getClientName={getClientName} getCaseName={getCaseName} isCloseToDueDateOrOverdue={isCloseToDueDateOrOverdue(task)} showActions={true} clickable={true} onTaskClick={handleViewTask} />)}
        ...
        <DialogContent className="sm:max-w-[700px]">
          ...
          <div className="space-y-4 py-4 max-h-[70vh] overflow-y-auto pr-2">
            ...
            <div className="space-y-4">
              ...
              {newTask.attachments.length > 0 && <div className="border rounded-md p-3 space-y-2">
                  {newTask.attachments.map((attachment, index) => <div key={index} className="flex items-center justify-between text-sm">
        ...
        <DialogContent className="sm:max-w-[700px] max-h-[90vh] overflow-y-auto">
              ...
              <Tabs defaultValue="details">
                ...
                <TabsContent value="details" className="space-y-4">
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    {selectedTask.caseId && <div className="col-span-2">
                ...
                <TabsContent value="attachments">
                  <div className="space-y-4">
                    ...
                    {selectedTask.attachments && selectedTask.attachments.length > 0 ? <div className="space-y-2">
                        {selectedTask.attachments.map((attachment, index) => <div key={index} className="flex items-center justify-between p-3 border rounded-md">
                            <div className="flex items-center gap-2">
                              {attachment.type === 'image' && <Image className="h-4 w-4" />}
                              {attachment.type === 'link' && <Paperclip className="h-4 w-4" />}
                              {attachment.type === 'document' && <FileText className="h-4 w-4" />}
                ...
                <TabsContent value="updates">
                  <div className="space-y-4">
                    ...
                    {selectedTask.updates && selectedTask.updates.length > 0 ? <div className="border rounded-md divide-y">
                        {selectedTask.updates.map(update => <div key={update.id} className="p-3">
          ...
          <DialogFooter>
            <div className="flex justify-between w-full">
              <Button 
                variant="default" 
                onClick={() => handleMarkAsCompleted(selectedTask?.id || '')}

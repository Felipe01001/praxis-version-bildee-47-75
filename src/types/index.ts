...
export type SubCategory = 
  ...
  | string;
export type CaseStatus = 'open' | 'completed'; // Status para atendimentos (cases)
export type TaskStatus = 'in-progress' | 'delayed' | 'completed'; // Status para tarefas (tasks)
export type Status = CaseStatus; // Mantém compatibilidade

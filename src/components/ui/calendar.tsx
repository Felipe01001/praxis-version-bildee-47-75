  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        head_row: "flex",
        head_cell:
          "text-muted-foreground rounded-md w-8 sm:w-9 h-8 sm:h-9 font-normal text-xs sm:text-[0.8rem] flex items-center justify-center",
        ...
        day: cn(
          ...
          "h-8 w-8 sm:h-9 sm:w-9 p-0 font-normal text-xs sm:text-sm aria-selected:opacity-100 touch-manipulation min-h-[32px] sm:min-h-[36px]"
        ),

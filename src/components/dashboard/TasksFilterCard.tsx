...
import { Task, Case, Client, TaskStatus } from '@/types';
...
export default function TasksFilterCard({ tasks, clients, cases, addTask, updateTask }: TasksFilterCardProps) {
  ...
  const handleCompleteTask = async () => {
    if (selectedTask) {
      await updateTask(selectedTask.id, { ...selectedTask, status: 'completed' });
        ...
        <DialogContent className="sm:max-w-[700px] max-h-[90vh] overflow-y-auto">
          ...
          <DialogFooter>
            ...
            {selectedTask && selectedTask.status !== 'completed' && (
              <Button onClick={handleCompleteTask} className="theme-primary-button">
